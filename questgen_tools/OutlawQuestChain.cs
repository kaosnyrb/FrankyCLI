...
namespace FrankyCLI.questgen_tools
{
    public class OutlawQuestChain
    {
        ...
        public bool GenerateQuest()
        {
            ...
            var ShowdownMissionTemplate = lib.GetShowdownMissionTemplate("City Bounty - New Atlantis");
            ...
            var InvestigationMissionTemplate = lib.GetInvestigationMissionTemplate("City Activator - New Atlantis");
            ...
            var invest2 = lib.GetInvestigationMissionTemplate("City Activator - New Atlantis");

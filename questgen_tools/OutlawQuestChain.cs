...
namespace FrankyCLI.questgen_tools
{
    public class OutlawQuestChain
    {
        ...
        public bool GenerateQuest()
        {
            ...
            var DeepInvestigationMissionTemplate = lib.GetInvestigationMissionTemplate("Space Activator - Spacer Trap");
            var InvestigationMissionTemplate = lib.GetInvestigationMissionTemplate("Space Activator - Ecliptic Trap");

...
namespace FrankyCLI
{
    ...
    class shipyfortyfiverotates
    {
        ...
        public static ExtendedList<SnapNodeEntry> CalculateNodes(directions direction, ExtendedList<SnapNodeEntry> nodes, IGameEnvironment env)
        {
            ...
            {
                //Spin 45 degrees on Y.
                //Fore rotates -45 on Y
                //Aft rotates -45 on Y
                //Star becomes Top
                //Top becomes Port
                //Port becomes Bottom
            ...
            {
                //Spin 135 degrees on Y.
                //Fore rotates -135 on Y
                //Aft rotates -135 on Y
            ...
            using (var env = GameEnvironment.Typical.Builder<IStarfieldMod, IStarfieldModGetter>(GameRelease.Starfield).Build())
            {
                ...
                foreach (var direction in flips)
                {
                    ...
                    */
                    ...
                    if (direction == directions.ShipModPositionTop) newobj.Rotation = new P3Float(0, EulerToRadCardinals(45), 0);
                    if (direction == directions.ShipModPositionPort) newobj.Rotation = new P3Float(0, EulerToRadCardinals(135), 0);

...
namespace FrankyCLI
{
    public class gen_spaceencounterquest
    {
        public static int Generate(string[] args)
        {
            ...
            using (var env = GameEnvironment.Typical.Builder<IStarfieldMod, IStarfieldModGetter>(GameRelease.Starfield).Build())
            {
                ...
                {                    
                    foreach (var quests in modlo.Value.Mod.Quests)
                    {
                        ...
                        {
                            if (quests.EditorID == "SE_duxf_CrimsonVsStarborn")//SE_EnemyShips_CrimsonStation "Trader" [QUST:0C00081E]
                            {
                                Quest quest2 = quests.Duplicate(quest1.FormKey);
                                myMod.Quests.Add(quest2);
                            }
                        }
                    }
                }
            ...
            //Note to change the quest refed in the aliaises to the current quest.

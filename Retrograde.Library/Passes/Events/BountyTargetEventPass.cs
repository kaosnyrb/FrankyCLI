    ...
    public class BountyTargetEventPass : IGenPass
    {
        ...
        private static string GetBountyName(string faction)
        {
            if (!string.IsNullOrWhiteSpace(faction) &&
                ...
                names.Length > 0)
            {
                return names[RandomProvider.Random.Next(names.Length)];
            }

            return DefaultBountyNames[RandomProvider.Random.Next(DefaultBountyNames.Length)];
        }
        ...
        private Armor CreateBountyArmor(string bountyName)
        {
            ...
            var armor = new Armor(RetrogradeContext.Current.TargetMod, $"rg_bounty_armor_{guid}")
            {
            ...
            RetrogradeContext.Current.TargetMod.Armors.Add(armor);
            return armor;
        }
